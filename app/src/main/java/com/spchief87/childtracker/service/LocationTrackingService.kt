package com.spchief87.childtracker.service
...
import com.spchief87.childtracker.MainActivity
import com.spchief87.childtracker.R
    ...
    private fun saveLocation(location: Location) {
        lifecycleScope.launch {
            try {
                ...
                // Используем новый метод для проверки изменения и автоматической синхронизации
                locationRepository.insertLocationIfChanged(locationData)
            } catch (e: Exception) {
                // Логирование ошибки
            }
        }
